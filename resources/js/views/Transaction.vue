<template>
  <div>
    <div>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Enter Employee Name</label>
      <input
    ...
    <div>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Enter Date</label>
      <input
        class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-1/4 appearance-none leading-normal"
        type="text"
    ...
    <div>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Enter Employer Name</label>
      <input
        class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-1/4 appearance-none leading-normal"
        type="text"
    ...
    <div class>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Select IRP5 Code</label>
      <select
      ...
      >
        ...
        <option v-for="item in irp5_codes" :key="item.id">{{ item.code }} - {{ item.description }}</option>
      </select>
    </div>
    <div>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Enter Amount</label>
      <input
        class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-1/4 appearance-none leading-normal"
        type="text"
    ...
    <div>
      <label class="block w-1/4 text-gray-700 text-sm font-bold my-2">Enter Notes</label>
      <input
        class="bg-white focus:outline-none focus:shadow-outline border border-gray-300 rounded-lg py-2 px-4 block w-1/4 appearance-none leading-normal"
        type="text"
    ...
    <table class="text-center mt-4">
      ...
      <tr v-for="item in transactions" :key="item.id">
        <td class="border border-black">{{ item.employee }}</td>
        <td class="border border-black">{{ item.date }}</td>
        <td class="border border-black">{{ item.employer }}</td>
        <td class="border border-black">{{ item.description }}</td>
        <td class="border border-black">{{ item.irp5_code }}</td>
        <td class="border border-black">R {{ item.amount }}</td>
